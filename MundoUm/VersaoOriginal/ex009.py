# Faça um progama que leia um número e exiba sua tabuada de multiplicar na tela
numero = int(input('Digite o número que você deseja ver a tabuada de multiplicar: '))
